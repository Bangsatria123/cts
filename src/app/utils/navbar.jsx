    ...
    return (
        <div className="flex flex-col">
            ...
            <nav className="flex items-center w-full  bg-primary text-secondary text-lg font-semibold  ps-28 mt-4 ">
                ...
                <Link  className={`px-6 py-1 rounded-md transition ease duration-300 ${pathname === '/event' ? 'bg-tertiary text-secondary hover:bg-secondary hover:text-tertiary' : 'hover:bg-secondary hover:text-tertiary'}`} href="/event">Event</Link>
                <Link  className={`px-6 py-1 rounded-md transition ease duration-300 ${pathname === '/about' ? 'bg-tertiary text-secondary hover:bg-secondary hover:text-tertiary' : 'hover:bg-secondary hover:text-tertiary'}`} href="/about">About</Link>
                <Link  className={`px-6 py-1 rounded-md transition ease duration-300 ${pathname === '/contact' ? 'bg-tertiary text-secondary hover:bg-secondary hover:text-tertiary' : 'hover:bg-secondary hover:text-tertiary'}`} href="/contact">Contact</Link>
            </nav>
        </div>
    )
}
